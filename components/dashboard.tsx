...
import type { DeliveryProof, Order, OrderAttachment, Quote, Rider, TeamMember, UserRole } from "@/lib/types";
...
export function Dashboard({ role }: { role: UserRole }) {
  ...
  const load = useCallback(async () => {
    try {
      const [loadedOrders, loadedRiders, loadedVendors, loadedQuotes, loadedAttachments, loadedProofs] = await Promise.all([
